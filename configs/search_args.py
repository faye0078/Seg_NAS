...
def obtain_search_args():
    ...
    # checking point
    parser.add_argument('--resume', type=str, default='/media/dell/DATA/wy/Seg_NAS/run/hps-GID/12layers_flexinet/model_best.pth.tar', help='put the path to resuming file if needed')
    ...
    parser.add_argument('--model_encode_path', type=str, default='/media/dell/DATA/wy/Seg_NAS/model/normal_connect_4.npy')
