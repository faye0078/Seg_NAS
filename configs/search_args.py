...
def obtain_search_args():
    ...
    parser.add_argument('--dataset', type=str, default='GID',
                        choices=['pascal', 'coco', 'cityscapes', 'kd', 'GID'],
                        help='dataset name (default: pascal)')
    parser.add_argument('--nas', type=str, default='search',
    ...
    parser.add_argument("--train-dir", type=str, default="../data/512/",
                         help="Path to the training set directory.")
    parser.add_argument("--val-dir", type=str, default="../data/512/",
                         help="Path to the validation set directory.")
    parser.add_argument("--test-dir", type=str, default="../data/512/",
                         help="Path to the test set directory.")
    parser.add_argument("--train-list", type=str, default="./data/lists/rs_train.lst",
                         help="Path to the training set list.",)
    parser.add_argument("--val-list", type=str, default="./data/lists/rs_val.lst",
                         help="Path to the validation set list.",)
    parser.add_argument("--test-list", type=str, default="./data/lists/rs_test.lst",
    ...
    parser.add_argument('--checkname', type=str, default='12layers',
