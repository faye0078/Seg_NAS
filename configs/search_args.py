...
def obtain_search_args():
    ...
    parser.add_argument('--model_encode_path', type=str, default='/media/dell/DATA/wy/Seg_NAS/model/model_encode/uadataset_dfc/one_loop_14layers_mixedcell/first_connect_4.npy')
