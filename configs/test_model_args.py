...
def obtain_test_args():
    ...
    parser.add_argument('--model_name', type=str, default='flexinet', choices=['one_path', 'multi', 'hrnet', 'flexinet', 'deeplabv3plus', 'pspnet', 'unet', 'refinenet', 'fast-nas'],  help='the model name')
