...
def obtain_retrain_args():
    ...
    parser.add_argument('--model_name', type=str, default='hrnet', choices=['one_path', 'multi', 'hrnet'], help='the model name')
    parser.add_argument('--resume', type=str, default=None, help='put the path to resuming file if needed')
    parser.add_argument('--checkname', type=str, default='12layers_forward_retrain/hrnet', help='set the checkpoint name')
    ...
    parser.add_argument('--dataset', type=str, default='cityscapes', choices=['pascal', 'coco', 'cityscapes', 'kd', 'GID', 'hps-GID'], help='dataset name (default: pascal)')
