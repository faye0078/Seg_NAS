CUDA_VISIBLE_DEVICES=3 python retrain_nas.py \
 --batch-size 12 --dataset GID --checkname '12layers_forward_retrain/one_path' --num_worker 4\
 ...
 --resume '/media/dell/DATA/wy/Seg_NAS/run/GID/12layers_forward_retrain/one_path/model_best.pth.tar'