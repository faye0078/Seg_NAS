...
def image_clip(img_path, size):
    ...
    img_dir = "../../../data/GID-5/768/image/" + img_name
...
def label_clip(img_path, size):
    ...
    img_dir = "../../../data/GID-5/768/label/" + img_name
    folder = os.path.exists(img_dir)
    if not folder:
        os.makedirs(img_dir)
